...
<div class="col-lg-6">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Hospital's Details</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="registerDate" class="form-control pull-right" id="datepicker" required>
                    </div>
                </div>
            ...
            <input id="hostRole" type="hidden" value="3">
