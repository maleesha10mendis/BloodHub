        ...
        <form id="addBloodForm">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" id="addBloodRadio" name="action" checked>
                    <label class="form-check-label" for="addBloodRadio">Add Blood</label>
                </div>
                <div class="form-check">
                    <input type="radio" class="form-check-input" id="useBloodRadio" name="action">
                    <label class="form-check-label" for="useBloodRadio">Use Blood</label>
                </div>
            </div>
            <div class="form-group">
...
<script>
    ...
    async function validateAndAddBlood() {
        ...
        var selectedAction = document.querySelector('input[name="action"]:checked').id;
        ...
        try {
            ...
            if (selectedAction === "addBloodRadio") {
                // Code to handle Add Blood action
                await window.addBloodStock(stockID, ownerID, bloodGroup, units);
            } else if (selectedAction === "useBloodRadio") {
                // Code to handle Get Blood action
                await window.executeBloodTransferByAdminOrg(stockID, 1000, ownerID,bloodGroup, units);
